...
pub const stateless = struct {
    ...
    pub const hevc = struct {
        ...
        pub const sei = struct {
            pub const PicStructFrame = c.V4L2_HEVC_SEI_PIC_STRUCT_FRAME;
            pub const PicStructTopField = c.V4L2_HEVC_SEI_PIC_STRUCT_TOP_FIELD;
            pub const PicStructBottomField = c.V4L2_HEVC_SEI_PIC_STRUCT_BOTTOM_FIELD;
            pub const PicStructTopBottom = c.V4L2_HEVC_SEI_PIC_STRUCT_TOP_BOTTOM;
            pub const PicStructBottomTop = c.V4L2_HEVC_SEI_PIC_STRUCT_BOTTOM_TOP;
            pub const PicStructTopBottomTop = c.V4L2_HEVC_SEI_PIC_STRUCT_TOP_BOTTOM_TOP;
            pub const PicStructBottomTopBottom = c.V4L2_HEVC_SEI_PIC_STRUCT_BOTTOM_TOP_BOTTOM;
            pub const PicStructFrameDoubling = c.V4L2_HEVC_SEI_PIC_STRUCT_FRAME_DOUBLING;
            pub const PicStructFrameTripling = c.V4L2_HEVC_SEI_PIC_STRUCT_FRAME_TRIPLING;
            pub const PicStructTopPairedPreviousBottom = c.V4L2_HEVC_SEI_PIC_STRUCT_TOP_PAIRED_PREVIOUS_BOTTOM;
            pub const PicStructBottomPairedPreviousTop = c.V4L2_HEVC_SEI_PIC_STRUCT_BOTTOM_PAIRED_PREVIOUS_TOP;
            pub const PicStructTopPairedNextBottom = c.V4L2_HEVC_SEI_PIC_STRUCT_TOP_PAIRED_NEXT_BOTTOM;
            pub const PicStructBottomPairedNextTop = c.V4L2_HEVC_SEI_PIC_STRUCT_BOTTOM_PAIRED_NEXT_TOP;
        };
...
test "stateless.av1.tile_group_entry.Ctrl ABI matches struct_v4l2_ctrl_av1_tile_group_entry" {
    ...
    const Z = stateless.av1.tile_group_entry.Ctrl;
    try std.testing.expectEqual(@sizeOf(C), @sizeOf(Z));
    try std.testing.expectEqual(@alignOf(C), @alignOf(Z));
...
test "stateless.av1.global_motion.Ctrl ABI matches struct_v4l2_av1_global_motion" {
    ...
    const Z = stateless.av1.global_motion.Ctrl;
    try std.testing.expectEqual(@sizeOf(C), @sizeOf(Z));
    try std.testing.expectEqual(@alignOf(C), @alignOf(Z));
    try std.testing.expectEqual(@offsetOf(C, "flags"), @offsetOf(Z, "flags"));
...
test "stateless.av1.loop_restoration.Ctrl ABI matches struct_v4l2_av1_loop_restoration" {
    ...
    const Z = stateless.av1.loop_restoration.Ctrl;
    try std.testing.expectEqual(@sizeOf(C), @sizeOf(Z));
    try std.testing.expectEqual(@alignOf(C), @alignOf(Z));
    try std.testing.expectEqual(@offsetOf(C, "flags"), @offsetOf(Z, "flags"));
...
test "stateless.av1.cdef.Ctrl ABI matches struct_v4l2_av1_cdef" {
    ...
    const Z = stateless.av1.cdef.Ctrl;
    try std.testing.expectEqual(@sizeOf(C), @sizeOf(Z));
    try std.testing.expectEqual(@alignOf(C), @alignOf(Z));
...
test "stateless.av1.segmentation.Ctrl ABI matches struct_v4l2_av1_segmentation" {
    ...
    const Z = stateless.av1.segmentation.Ctrl;
    try std.testing.expectEqual(@sizeOf(C), @sizeOf(Z));
    try std.testing.expectEqual(@alignOf(C), @alignOf(Z));
    try std.testing.expectEqual(@offsetOf(C, "flags"), @offsetOf(Z, "flags"));
...
test "stateless.av1.loop_filter.Ctrl ABI matches struct_v4l2_av1_loop_filter" {
    ...
    const Z = stateless.av1.loop_filter.Ctrl;
    try std.testing.expectEqual(@sizeOf(C), @sizeOf(Z));
    try std.testing.expectEqual(@alignOf(C), @alignOf(Z));
    try std.testing.expectEqual(@offsetOf(C, "flags"), @offsetOf(Z, "flags"));
    try std.testing.expectEqual(@offsetOf(C, "level"), @offsetOf(Z, "level"));
...
test "stateless.av1.quantization.Ctrl ABI matches struct_v4l2_av1_quantization" {
    ...
    const Z = stateless.av1.quantization.Ctrl;
    try std.testing.expectEqual(@sizeOf(C), @sizeOf(Z));
    try std.testing.expectEqual(@alignOf(C), @alignOf(Z));
    try std.testing.expectEqual(@offsetOf(C, "flags"), @offsetOf(Z, "flags"));
    try std.testing.expectEqual(@offsetOf(C, "base_q_idx"), @offsetOf(Z, "base_q_idx"));
...
test "stateless.av1.tile_info.Ctrl ABI matches struct_v4l2_av1_tile_info" {
    ...
    const Z = stateless.av1.tile_info.Ctrl;
    try std.testing.expectEqual(@sizeOf(C), @sizeOf(Z));
    try std.testing.expectEqual(@alignOf(C), @alignOf(Z));
    try std.testing.expectEqual(@offsetOf(C, "flags"), @offsetOf(Z, "flags"));
...
test "stateless.av1.frame.Ctrl ABI matches struct_v4l2_ctrl_av1_frame" {
    ...
    const Z = stateless.av1.frame.Ctrl;
    try std.testing.expectEqual(@sizeOf(C), @sizeOf(Z));
    try std.testing.expectEqual(@alignOf(C), @alignOf(Z));
...
test "stateless.av1.film_grain.Ctrl ABI matches struct_v4l2_ctrl_av1_film_grain" {
    ...
    const Z = stateless.av1.film_grain.Ctrl;
    try std.testing.expectEqual(@sizeOf(C), @sizeOf(Z));
    try std.testing.expectEqual(@alignOf(C), @alignOf(Z));
    try std.testing.expectEqual(@offsetOf(C, "flags"), @offsetOf(Z, "flags"));
